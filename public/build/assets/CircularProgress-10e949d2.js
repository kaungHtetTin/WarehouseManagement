import{r as h,e as z,a as y,j as A}from"./app-657e98b3.js";import{g as G,a as K,H as M,I as R,s as l,e as j,m as C,b as V,c as W,d as B,j as H}from"./Stack-23e3cb9b.js";let w=0;function Z(r){const[e,t]=h.useState(r),a=r||e;return h.useEffect(()=>{e==null&&(w+=1,t(`mui-${w}`))},[e]),a}const q={...z},D=q.useId;function ar(r){if(D!==void 0){const e=D();return r??e}return Z(r)}function J(r){return G("MuiCircularProgress",r)}K("MuiCircularProgress",["root","determinate","indeterminate","colorPrimary","colorSecondary","svg","track","circle","circleDisableShrink"]);const s=44,x=M`
  0% {
