import{r as h,e as z,a as y,j as A}from"./app-7edba347.js";import{g as G,a as K,R,U as M,s as l,j as U,m as C,b as V,c as W,d as B,l as Z}from"./Stack-7dc84e9e.js";let D=0;function q(r){const[e,t]=h.useState(r),a=r||e;return h.useEffect(()=>{e==null&&(D+=1,t(`mui-${D}`))},[e]),a}const H={...z},I=H.useId;function ar(r){if(I!==void 0){const e=I();return r??e}return q(r)}function J(r){return G("MuiCircularProgress",r)}K("MuiCircularProgress",["root","determinate","indeterminate","colorPrimary","colorSecondary","svg","track","circle","circleDisableShrink"]);const s=44,x=R`
  0% {
