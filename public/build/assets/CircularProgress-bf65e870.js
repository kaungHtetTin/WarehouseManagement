import{r as h,e as z,a as y,j as A}from"./app-5ca4fb8c.js";import{g as G,a as K,$ as M,a0 as R,s as l,f as N,m as C,b as V,d as W,e as B,l as Z}from"./Stack-27bee6ff.js";let D=0;function q(r){const[e,t]=h.useState(r),a=r||e;return h.useEffect(()=>{e==null&&(D+=1,t(`mui-${D}`))},[e]),a}const H={...z},I=H.useId;function ar(r){if(I!==void 0){const e=I();return r??e}return q(r)}function J(r){return G("MuiCircularProgress",r)}K("MuiCircularProgress",["root","determinate","indeterminate","colorPrimary","colorSecondary","svg","track","circle","circleDisableShrink"]);const s=44,x=M`
  0% {
