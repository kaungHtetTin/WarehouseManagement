import{r as h,e as z,a as y,j as A}from"./app-a1fbec69.js";import{g as G,a as K,Q as R,R as M,s as l,e as j,m as C,b as V,c as W,d as B,j as Q}from"./Stack-abbafcf2.js";let D=0;function Z(r){const[e,t]=h.useState(r),a=r||e;return h.useEffect(()=>{e==null&&(D+=1,t(`mui-${D}`))},[e]),a}const q={...z},I=q.useId;function ar(r){if(I!==void 0){const e=I();return r??e}return Z(r)}function H(r){return G("MuiCircularProgress",r)}K("MuiCircularProgress",["root","determinate","indeterminate","colorPrimary","colorSecondary","svg","track","circle","circleDisableShrink"]);const s=44,x=R`
  0% {
