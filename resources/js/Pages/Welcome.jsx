        ...
        <>
            ...
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                <div className="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                    <Link
                        href={`${adminUrl}/ui-showcase`}
                        className="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 mr-4"
                    >
                        UI Showcase
                    </Link>
                    {props.auth.user ? (
                ...
                <div className="max-w-7xl mx-auto p-6 lg:p-8">
                    <Stack spacing={2} sx={{ mb: 4 }}>
                        <Alert severity="success">Laravel + Inertia + React + MUI is ready.</Alert>
                        <Button variant="contained" href="https://mui.com/material-ui/getting-started/overview/">
                            Open MUI Docs
                        </Button>
                    </Stack>
